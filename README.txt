...
ASTRIAL is an SoM based on two main components: NXP i.mx8m-plus CPU and Hailo H8 for NPU.
The Hailo NPU allows an efficient inference of neural networks (especially CNN) for object detection and similar applications.
...
- how to benchmark Hailo compiled networks for speed, data transfer and latency using HailoRT library
- how to execute a full pipeline for object detection using GStreamer, python or C++ code.
