...
function init_variables() {
    ...
    readonly DEFAULT_VIDEO_SOURCE="./resources/video.mp4"
...
function print_usage() {
    ...
    echo "  -i INPUT --input INPUT          Set the video file (default $input_source)"
...
PIPELINE="gst-launch-1.0 \
    ...
    qtdemux ! queue ! h264parse ! vpudec ! videoconvert ! \
